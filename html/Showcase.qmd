...
If you end up using any of the following model please cite [Guri et al., 2024 (Quantifying the Detection Sensitivity and Precision of qPCR and ddPCR Mechanisms for eDNA Samples)](https://onlinelibrary.wiley.com/doi/full/10.1002/ece3.70678) for models 1 and 2. For models 3 - 5 please cite [Guri et al., 2024 (Predicting trawl catches using environmental DNA)](https://academic.oup.com/icesjms/article/81/8/1536/7728836)
...
The function `amp_eff_output_extract` creates a data frame that puts things in perspective by extracting and computing the values on [Equation 3.3]({#Model_3})
